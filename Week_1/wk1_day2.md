# Lets 'Git' It!
Here we are going to go over the commands in Git.
...
Gitignore & Gitkeep
About: help.github.com/articles/ignoring-files

Useful templates: github.com/github/gitignore
