...
Here are some images of my dog if you need images, otherwise feel free to use whatever images you want!
...
Like I said, this is a solved problem. So let's try using Swiper. Swiper is a great library used on many websites, including Frontend Master's own website. It's well written, small, and fast.
...
Great! Now let's grab some code from Popmotion's site. Scroll down to the section on Spring. Click fork the CodePen. Grab the JavaScript and paste it in your JavaScript file.
...
Here's my second version, with the libraries.
